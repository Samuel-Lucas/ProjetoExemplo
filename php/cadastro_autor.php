...
<html lang="pt-br">
    <head>
        ...
        <title>Simples Blog - Cadastro de autores</title>
    </head>
                ...
                <h3 class="mb-4">Cadastro de autores</h3>
                    <form action="actions/cadastrar_autores.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email" id="email"  onkeyup="valida_campos()">
                        </div>
                        ...
                        <button type="submit" name="cadastrar" id="cadastrar-autores" class="btn btn-success mb-4">Cadastrar</button>
                    </form>
                </div>
            </div>
        </div>
